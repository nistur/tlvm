...
TLVM_INSTRUCTION_BASE(6800, COM);
...
TLVM_INSTRUCTION_VARIATION(6800, COMA,  0x41);

TLVM_INSTRUCTION_VARIATION(6800, NEGB,  0x50);
TLVM_INSTRUCTION_VARIATION(6800, COMB,  0x51);

TLVM_INSTRUCTION_VARIATION(6800, NEGX,  0x60);
TLVM_INSTRUCTION_VARIATION(6800, COMX,  0x61);

TLVM_INSTRUCTION_VARIATION(6800, NEGE,  0x70);
TLVM_INSTRUCTION_VARIATION(6800, COME,  0x71);
